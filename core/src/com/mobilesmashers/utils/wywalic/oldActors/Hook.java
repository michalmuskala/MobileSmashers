...
public class Hook extends com.mobilesmashers.utils.wywalic.oldActors.GameActor {

	private com.mobilesmashers.utils.wywalic.oldActors.GameActor owner;

	public Hook(Vector2 position, Vector2 size, Vector2 speed, Texture texture) {
		super(position, size, speed, texture);
	}

	public Hook(Vector2 size, com.mobilesmashers.utils.wywalic.oldActors.GameActor owner, Texture texture) {
